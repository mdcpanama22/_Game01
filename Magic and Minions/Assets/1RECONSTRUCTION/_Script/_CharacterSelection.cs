...
public class _CharacterSelection : MonoBehaviour {
   ...
   public int num;
    ...
    public GameObject SpellSelection2;

    public GameObject Undo_b;
    public GameObject Ready_G;
    public GameObject Ready_b;
    public GameObject Ready_b2;
    public GameObject Description_b;

    public GameObject Beserker;
    public GameObject Necro;

    public GameObject ClassTemp;
