...
public class SpellList : MonoBehaviour {
    ...
    public GameObject AbilitiesSpellUI;
    Spell CurrentSpell;
   ...
   //BESERKER
    ...
    void Start() {
        ...
        List<Spell> Beserker = new List<Spell>();
            ...
            //Drunkard Minion
        string Descrip = "Summon a 2 Damage, 4 Health Drunkard, for 2 Mana";
        Spell A = new Spell("Drunkard", Descrip, Drunkard_State, Drunkard_Range, DEFAULT, Drunkard_Cost, Drunkard_Types, Drunkard_Range_Type);
        Beserker.Add(A);

            //Orcish Grunt Minion
        Descrip = "Summon a 2 Damage, 3 Health Orcish Grunt, for 3 Mana. Can attack twice";
        A = new Spell("Orcish_Grunt", Descrip, Orcish_Grunt_State, Orcish_Grunt_Range, DEFAULT, Orcish_Grunt_Cost, Orcish_Grunt_Types, Orcish_Grunt_Range_Type);
        Beserker.Add(A);

            //Mana Wisp Minion
        Descrip = "Summon a 1 Damage, 3 Health Mana Wisp, for 5 Mana. Gain 1 mana at the end of your turn";
        A = new Spell("Mana_Wisp", Descrip, Mana_Wisp_State, Mana_Wisp_Range, DEFAULT, Mana_Wisp_Cost, Mana_Wisp_Types, Mana_Wisp_Range_Type);
        Beserker.Add(A);

        //Blink Spell
        Descrip = "Teleport 1 + (rage) spaces, for 3 Mana";
        A = new Spell("Blink", Descrip, Blink_State, Blink_Range, DEFAULT, Blink_Cost, Blink_Type, Blink_Range_Type);
        Beserker.Add(A);

            //Molotov Throw Spell
        Descrip = "Deal 4 damage to target space within a range of 2, dealing 4 damage to chosen space, and 1 to the spaces around, for 5 Mana";
        A = new Spell("Molotov_Throw", Descrip, Molotv_Throw_State, Molotv_Throw_Range, DEFAULT, Molotv_Throw_Cost, Molotov_Throw_Types, Molotv_Throw_Range_Type);
        Beserker.Add(A);
        ...
        Descrip = "Berserker gains 1 mana after each melee attack, and after every time Berserker moves, deal 1 damage to up to 2 adjacent units";
        A = new Spell("Arcane_Blood", Descrip, Arcane_Blood_State, Arcane_Blood_Range, DEFAULT, Arcane_Blood_Cost, Arcane_Blood_Types, Arcane_Blood_Range_Type);
        Beserker.Add(A);
            //Bloodfury Passive
        Descrip = "Bloodfury, gain 1 rage for every kill your hero makes with melee attacks or spells";
        A = new Spell("Bloodfury", Descrip, Bloodfury_State, Bloodfury_Range, DEFAULT, Bloodfury_Cost, Bloodfury_Blood_Types, Bloodfury_Range_Type);
        Beserker.Add(A);
            //Bloodfury Passive
        Descrip = "Stagger, ever time you cast a spell, you must stagger 1 space before casting";
        A = new Spell("Stagger", Descrip, Stagger_State, Stagger_Range, DEFAULT, Stagger_Cost, Stagger_Types, Stagger_Range_Type);
        Beserker.Add(A);
            //Superstitious Passive
        Descrip = "Heal 2 health when targeted by any spell";
        A = new Spell("Superstitious", Descrip, Superstitious_State, Superstitious_Range, DEFAULT, Superstitious_Cost, Superstitious_Types, Superstitious_Range_Type);
        Beserker.Add(A);
        //Chug
        Descrip = "Gain 4 Mana or 1 Rage, but no longer can take an action";
        A = new Spell("Chug", Descrip, Chug_State, Chug_Range, DEFAULT, Chug_Cost, Chug_Types, Chug_Range_Type);
        Beserker.Add(A);
            //Drunken Cleave Spell
        Descrip = "Stagger 2 spaces, then deal 3 damage to 2 continious adjacent spaces, for 4 Mana";
        A = new Spell("Drunken_Cleave", Descrip, Drunken_Cleave_State, Drunken_Cleave_Range, DEFAULT, Drunken_Cleave_Cost, Drunken_Cleave_Types, Drunken_Cleave_Range_Type);
        Beserker.Add(A);

        
            //Painkiller Spell
        Descrip = "Restore 4 hp to Berserker, for 4 mana or 1 rage";
        A = new Spell("Painkiller", Descrip, Painkiller_State, Painkiller_Range, DEFAULT, Painkiller_Cost, Painkiller_Types, Painkiller_Range_Type); 
        Beserker.Add(A);
            //Vicious Cleave Spell
        Descrip = "Deal 6 damage to two adjacent units, and gain one rage per kill, for 7 Mana or 5 Rage";
        A = new Spell("Vicious_Cleave", Descrip, Vicious_Cleave_State, Vicious_Cleave_Range, DEFAULT, Vicious_Cleave_Cost, Vicious_Cleave_Types, Vicious_Cleave_Range_Type);
        Beserker.Add(A);

            //Vanish Spell
        Descrip = "Teleport to a square 3 spaces away, for 1 essence";
        A = new Spell("Vanish", Descrip, Vanish_State, Vanish_Range, DEFAULT,Vanish_Cost, Vanish_Types, Vanish_Range_Type);
        Beserker.Add(A);
        ...
        Descrip = "Summon 1 damage, 2 health Wisp with 2 moves, for 1 Mana";
        A = new Spell("Wisp", Descrip, Wisp_State, Wisp_Range, DEFAULT, Wisp_Cost, Mana_Wisp_Types, Mana_Wisp_Range_Type);
        Necromancer.Add(A);

        Descrip = "Summon 3 damage, 2 health Skeleton, for 2 Mana";
        A = new Spell("Skeleton", Descrip, Skeleton_State, Skeleton_Range, DEFAULT, Skeleton_Cost, Skeleton_Types, Skeleton_Range_Type);
        Necromancer.Add(A);

        Descrip = "Summon 3 damage, 4 health Wraith, for 3 Mana";
        A = new Spell("Wraith", Descrip, Wraith_State, Wraith_Range, DEFAULT, Wraith_Cost, Wraith_Types, Wraith_Range_Type);
        Necromancer.Add(A);

        Descrip = "Minions that you kill rise again as zombies and have damage and hp reduced by 50%";
        A = new Spell("Plague", Descrip, Plague_State, Plague_Range, DEFAULT, Plague_Cost, Plague_Types, Plague_Range_Type);
        Necromancer.Add(A);

        Descrip = "Rising Darkness, friendly zombies gain + 1/4 damage and + 1/2 hp for each shadow Necromancer has when they rise";
        A = new Spell("Rising_Darkness", Descrip, Rising_Darkness_State, Rising_Darkness_Range, DEFAULT, Rising_Darkness_Cost, Rising_Darkness_Types, Rising_Darkness_Range_Type);
        Necromancer.Add(A);

        Descrip = "Pay life equal to a minion’s hp to take control of it, for 2 Mana";
        A = new Spell("Possession", Descrip, Possession_State, Possession_Range, DEFAULT, Possession_Cost, Possession_Types, Possession_Range_Type);
        Necromancer.Add(A);

        Descrip = "Summon 4 wisps adjacent to the Necromancer and deal 3 damage to the Necromancer";
        A = new Spell("Soul_Swarm", Descrip, Soul_Swarm_State, Soul_Swarm_Range, DEFAULT, Soul_Swarm_Cost, Soul_Swarm_Types, Soul_Swarm_Range_Type);
        Necromancer.Add(A);

        Descrip = "Deal 2 damage in a right cone of radius 2, heal Necromancer for half damage dealt";
        A = new Spell("Soul_Inhale", Descrip, Soul_Inhale_State, Soul_Inhale_Range, DEFAULT, Soul_Inhale_Cost, Soul_Inhale_Types, Soul_Inhale_Range_Type);
        Necromancer.Add(A);

        Descrip = "Place a 5 health, monolith which generates 1 shadow for the Necromancer each turn";
        A = new Spell("Dark_Monolith", Descrip, Dark_Monolith_State, Dark_Monolith_Range, DEFAULT, Dark_Monolith_Cost, Dark_Monolith_Types, Dark_Monolith_Range_Type);
        Necromancer.Add(A);

        Descrip = "Kill a friendly minion to teleport up to its hp in spaces away";
        A = new Spell("Energy_Sling", Descrip, Energy_Sling_State, Energy_Sling_Range, DEFAULT, Energy_Sling_Cost, Energy_Sling_Types, Energy_Sling_Range_Type);
        Necromancer.Add(A);

        Descrip = "Destroy a friendly minion to deal its damage to one target within 2 spaces of it, for 2 mana or 1 shadow";
        A = new Spell("Essence_Projection", Descrip, Essence_Projection_State, Essence_Projection_Range, DEFAULT, Essence_Projection_Cost, Essence_Projection_Types, Essence_Projection_Range_Type);
        Necromancer.Add(A);


        Descrip = "Deal 4 damage to target and 2 to Necromancer";
        A = new Spell("Soul_Rot", Descrip, Soul_Rot_State, Soul_Rot_Range, DEFAULT, Soul_Rot_Cost, Soul_Rot_Types, Soul_Inhale_Range_Type);
        Necromancer.Add(A);
