...
public class GM : MonoBehaviour{
	...
	public GameObject First, Player, EventSystem, CurrentObject, PLAYERLIST;
	...
	public List<Spell> ICS, ICS2; //List of Spells
	
	//Buttons for each class
	public List<Button> NecromancerButtons, BeserkerButtons;

	public List<SpellButtons> SpellButtons_;
	
	public Material[] Pedestal_Color, Square_Color;
